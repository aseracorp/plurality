...
var ImageGenTool = utils.AITool{
	...
	ToolRequest: utils.ToolsRequest{
		...
		Function: utils.FunctionToolsRequest{
			Name:        "generate_image",
			Description: "Generate an image from a text description. Use this tool when the user asks you to create, draw, generate, design, or make an image, picture, illustration, photo, artwork, or any visual content. Write a detailed, descriptive prompt that will produce great results for image generation.",
			Parameters: &utils.ParameterToolsRequest{
				Type: "object",
				Properties: map[string]utils.PropertyParameterToolsRequest{
					"prompt": {
						Type:        "string",
						Description: "A detailed image generation prompt describing the desired image. Be specific about style, composition, colors, lighting, and subject matter.",
					},
				},
